...
class LiveLspClient {
  ...
  async start() {
    ...
    this.connection.onRequest("client/unregisterCapability", (params) => {
      // LSP 3.17 retains the historical `unregisterations` misspelling.
      const entries = params.unregisterations || params.unregistrations || [];
    ...
    this.connection.onRequest("workspace/applyEdit", (params) => {
